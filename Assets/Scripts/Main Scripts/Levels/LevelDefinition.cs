...
public sealed class LevelDefinition : ScriptableObject
{
    ...
    [Header("Hidden Bombs")]
    [SerializeField] private BombLevelSettings bombs = BombLevelSettings.Disabled;
    [SerializeField, Tooltip("Solver-verified layouts. Generated by Tools > Coca Sorting > Levels > Generate Bomb Layouts; one is used per attempt so a restart re-rolls without risking an unwinnable board.")]
    ...
    public BombLevelSettings Bombs => bombs;
    ...
    public void EditorSetBombs(BombLevelSettings newSettings)
    {
        bombs = newSettings;

        // Any change to the rules invalidates the pool that was verified against
        // them - a layout proved winnable at two bombs says nothing about four.
        // Clearing here means a stale pool can never survive a re-author.
        bombLayoutPool = new List<BombLayout>();
    }

    public void EditorSetBombLayoutPool(List<BombLayout> pool)
    {
        bombLayoutPool = pool ?? new List<BombLayout>();
    }
